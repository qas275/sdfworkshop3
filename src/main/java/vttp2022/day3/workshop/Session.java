        ...
        while(!stop){
            ...
            switch(terms[0]){
                ...
                case LOAD:
                    ...
                    break;//take data from file and put into linkedlist

                case SAVE:
                    repository.save(currCart);
                    System.out.println("Done !");
                    break;//take from linkedlist and store into the user's cart file, write into txt

                case LOGIN:
                    currCart = new Cart(terms[1]);
                    System.out.printf("%s login OK", terms[1]);
                    break;// instantiate new cart with 
